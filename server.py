...
# Copyright 2013 Abram Hindle, Eddie Antonio Santos, Ruilin Ma
# 
...
class MyWebServer(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        ...
        # print ("newAddress is : ", newAddress)
        ...
        if os.path.isdir(newAddress):  
            ...
            if newAddress[-1] == '/':
                ...
                # print("HTTP/1.1 301 Moved Permanently Location:" + newAddress + "/" + "\r\n")
            ...
            #f.readlines()
            txt = file.read().replace('\n', '')
            # print ("file is: ", file.read().replace('\n', ''))
            if newAddress[-4:] == ".css":
